---
title: "学术场景数据处理：论文总结翻译润色"
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/OOYswh8h8ig2Qrk1EbUcroNVnDg
node_token: OOYswh8h8ig2Qrk1EbUcroNVnDg
obj_token: QQcAdPt98oS7u6xl3xlczrw8n8e
obj_type: docx
...
> [!abstract]- 🖼 图片展示的是智谱AI大模型开放平台的GLM-4-Flash模型宣传图。图
> 图片展示的是智谱AI大模型开放平台的GLM-4-Flash模型宣传图。图中以蓝色调为主，背景有蓝色六边形图案和旋转的蓝色球体。左上角有“BigModel”标识。中间大字“GLM-4-Flash”下方有“免费 | 好用 | 高并发”字样，再下是“让百万开发者实现Tokens自由”。该图片与文档中介绍大模型技术革新学术研究，能快速总结论文内容、精准翻译，帮助研究者聚焦核心问题的上下文紧密相关，体现了模型的便捷性和高效性。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/NLwFbfAmAo9i6TxPpMIcqGW4nrd) · `NLwFbfAmAo9i6TxPpMIcqGW4nrd`

# 场景介绍

大模型技术正全面革新学术研究的传统方式。面对海量论文资料，研究者亟需高效工具来减轻工作量。以智谱GLM系列模型为代表的语言模型，凭借强大的语义理解能力，能够快速总结论文内容、或者进行精准翻译。这不仅节省了研究者阅读和整理文献的时间，还能帮助他们聚焦于核心问题。

模型的通用性使其能够适应不同学科和复杂文本，从中提炼出清晰的核心观点，为研究工作提速。无论是学者梳理文献、设计研究方案，还是学生快速掌握课程重点，大模型都能显著降低知识获取的难度，减少学科背景的限制。

总之，大语言模型通过减轻文献处理的负担，让研究者将更多精力投入到创新和实践中，是提升学术效率与质量的得力工具。

> [!abstract]- 🖼 图片为咨询大模型解决方案专家的宣传图，背景为蓝色渐变，左侧有类似玻璃球的
> 图片为咨询大模型解决方案专家的宣传图，背景为蓝色渐变，左侧有类似玻璃球的装饰图案。右侧上方文字为“咨询大模型解决方案专家”，下方文字是“扫描二维码，助力AI应用落地”，并配有二维码。该图片位于文档结尾处，是对文档内容的补充说明，鼓励读者扫描二维码咨询大模型解决方案专家，以助力AI应用落地，与文档中介绍大语言模型在学术场景数据处理中的应用等内容相呼应。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/LU5nbQ75BoUp3Sxk9Y9cQLEinlh) · `LU5nbQ75BoUp3Sxk9Y9cQLEinlh`

# 一、论文处理全景图

> [!abstract]- 🖼 图片展示了学术场景数据处理的全景图。中心为“学术场景数据处理”，周围有四
> 图片展示了学术场景数据处理的全景图。中心为“学术场景数据处理”，周围有四个步骤：1. 论文关键信息抽取，整理学术论文内容；2. 论文内容总结，对抽取部分文章内容精简提炼；3. 论文内容翻译，精准转换专业术语；4. 论文内容润色，将内容转化为社交媒体科普内容。该图与上下文紧密相关，直观呈现了大语言模型在学术场景中处理论文的全流程。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/CAJ8bxBwkoFMAIxCQLXcYgPfn5c) · `CAJ8bxBwkoFMAIxCQLXcYgPfn5c`

# 二、方案详情

## 文献预处理

海量文献通常以PDF、Word或Excel等格式存储，在使用大模型处理前，需要将其转换为可供模型解析的文本格式。您可以借助平台工具高效完成[文件内容的提取](https://www.bigmodel.cn/dev/api/knowlage-manage/queryextract)。
...
> [!abstract]- 🖼 图片展示的是论文《In-context learning through
> 图片展示的是论文《In-context learning through the bayesian prism》的参考文献部分。文献以作者姓名、标题、出版年份、来源等格式排列，如Kabir Ahuja等人的论文发表于2023年，Stella Biderman等人的论文发表于2023年，Peter F. Brown等人的论文发表于1993年，Tom Brown等人的论文发表于2020年。部分文献链接以蓝色字体呈现。该图片与上下文关系紧密，是对论文引用文献部分的展示，帮助学生快速了解论文引用的文献信息。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/P3znbphNdowrTNxDXCxcbRE1nKU) · `P3znbphNdowrTNxDXCxcbRE1nKU`
...
2.识别文本中的文献引用，排除专利引用。
3.按照指定格式提取文献引用信息。
4.严格按照 outforamt 输出内容,并输出JSON格式。
```

文献提取结果：

> [!abstract]- 🖼 图片展示了论文关键信息提取的示例结果。包含三篇文献信息，每篇文献有作者名
> 图片展示了论文关键信息提取的示例结果。包含三篇文献信息，每篇文献有作者名、标题、出版年份、出版商等字段。第一篇作者为Tom Brown等，标题是“Language models are few-shot learners”，出版年份为2020年，出版商是Curran Associates, Inc.；第二篇作者为Sachin Kumar等，标题是“GEN-Z: GENERATIVE ZERO-SHOT TEXT CLASSIFICATION WITH CONTEXTUALIZED LABEL DESCRIPTIONS”，出版年份为空；第三篇作者为Xudong Han等，标题是“Decoupling adversarial training for fair NLP”，出版商是Association for Computational Linguistics。这些信息与上文文献提取提示词相关，展示了提取结果样式。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Hn2JbbMPsonLydxVEnscwE9OnJf) · `Hn2JbbMPsonLydxVEnscwE9OnJf`
...
> [!abstract]- 🖼 图片展示的是论文《GEN-Z: GENERATIVE ZERO-SHOT
> 图片展示的是论文《GEN-Z: GENERATIVE ZERO-SHOT TEXT CLASSIFICATION WITH CONTEXTUALIZED LABEL DESCRIPTIONS》的封面。作者为Sachin Kumar、Chan Young Park、Yulia Tsvetkov，分别来自Allen Institute for AI、Carnegie Mellon University、University of Washington。摘要部分指出语言模型（LM）提示是一种解决NLP任务的流行范式，但易受提示微调和对轻微提示变化的敏感性影响。论文提出GEN-Z，一种生成提示方法，用于零样本文本分类，通过简单上下文化标签描述，实现零样本和少量样本基线的性能，同时增强对提示变化的鲁棒性。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Ewv3bJO0qoOa83xbGO5cFz6Gn3f) · `Ewv3bJO0qoOa83xbGO5cFz6Gn3f`
...
GLM结合良好的提示词能够帮助学生快速翻译论文内容，提高论文阅读效率。
...
通过精心设计的润色提示词，我们能够确定不同的润色风格，从而生成多样化的润色结果。在这里，我们将论文中的结论部分稍加润色，使之更易于在小红书上分享，转化为贴近生活的帖子，让复杂的学术知识以通俗易懂的方式呈现，吸引更多普通大众的关注和兴趣。

论文中结果部分：

> [!abstract]- 🖼 图片展示的是论文中“CONCLUSIONS”部分的内容。介绍了GEN-Z
> 图片展示的是论文中“CONCLUSIONS”部分的内容。介绍了GEN-Z框架，其为鲁棒的生成零样本文本分类框架，能无缝融入输入文本之外的上下文信息。GEN-Z基于不同标签描述生成输入文本，利用语言模型生成概率，比区分性方法更稳健。实验在两类任务中评估，涵盖19个不同任务、领域和难度级别的文本分类数据集，结果表明GEN-Z在零样本基线和强少样本基线中表现相当，且在多标签描述同义词中表现更好。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/A0XRbzWaLoRwKIxrdsvcLHErnHe) · `A0XRbzWaLoRwKIxrdsvcLHErnHe`
...
> [!abstract]- 🖼 图片为咨询大模型解决方案专家的宣传图，背景为蓝色渐变，左侧有类似玻璃球的
> 图片为咨询大模型解决方案专家的宣传图，背景为蓝色渐变，左侧有类似玻璃球的透明球体图案。右侧上方文字为“咨询大模型解决方案专家”，下方文字是“扫描二维码，助力AI应用落地”，右上角有二维码。该图片位于文档润色示例（小红书科普）部分之后，可能是文档结尾处的推广内容，引导读者扫描二维码获取大模型解决方案相关咨询。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/HIaXbNS6eocozOx3Oguc20mZnxg) · `HIaXbNS6eocozOx3Oguc20mZnxg`
