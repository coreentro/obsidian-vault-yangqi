---
title: "Agent 搭建共学快闪 0619"
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/XSJlwkJHXik40Uk2L7ocjky9nHb
node_token: XSJlwkJHXik40Uk2L7ocjky9nHb
obj_token: A5aydFTWfo3PmgxdcAIcpGbWnmc
obj_type: docx
...
breadcrumb:
  ...
  - "2. Agent 共学快闪活动"
  - "Agent 搭建共学快闪 0619"
obj_create_time: 1718529344
obj_edit_time: 1737699192
...
<callout emoji="💡">
飞书会议：https://vc.feishu.cn/j/929625812
B 站回放地址：https://space.bilibili.com/259768893/channel/collectiondetail?sid=2948315  
可以加入日历，之后的活动都会在这里通知
...
> 本次共学《微信机器人》活动，会在直播中进行完整的操作教学。会用到一些网站工具，需要注册和实名认证。
> 
> 如果**提前准备，会更容易跟上操作步骤，如果未提前准备，也不影响学习**，直播时会给大家留出一定的操作时间。建议提前准备。

**以下准备，大约需要5-8分钟。**

### **1、微信准备（可跳过）**

机器人完成后，需要微信进行登录。因为是非常规操作，因此，**建议使用微信小号**。

如果**暂时没有微信小号**也没有关系，可以**先用自己的微信体验**，后续自己再决定是否注册小号。

### **2、注册智谱AI**

**1、进入智谱AI：https://open.bigmodel.cn/**

> [!abstract]- 🖼 图片展示了智谱AI大模型MaaS开放平台的首页。背景为蓝色渐变，上方有平
> 图片展示了智谱AI大模型MaaS开放平台的首页。背景为蓝色渐变，上方有平台名称及导航栏。中间大标题为“生成式AI时代的基座I”，副标题介绍其基于领先模型打造高效、通用化“模型即服务”AI开发新范式。下方有“开始体验”和“点击注册”两个按钮，其中“开始体验”按钮被红色框线突出显示。该图片与文档中“注册智谱AI”部分内容相关，对应进入平台后可进行的体验和注册操作。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/WnhqbHheco8kSFxiyWycCLZ2n6d) · `WnhqbHheco8kSFxiyWycCLZ2n6d`

**2、点击开始使用，注册登录。**

> [!abstract]- 🖼 图片展示的是智谱AI开放平台的登录页面。页面左侧有平台介绍，包括“全栈自
> 图片展示的是智谱AI开放平台的登录页面。页面左侧有平台介绍，包括“全栈自研”“性能飞跃”“免费体验”等内容。右侧是登录区域，有“验证码登录”和“账号登录”选项，当前选中“验证码登录”，需输入手机号并获取验证码，下方还有“登录/注册”和“CCF会员授权登录”按钮。该图片与文档中“注册智谱AI”部分内容对应，直观呈现了注册登录的操作界面。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/ZtLqbEgmNoHJ8rxgl5bcYcytnsy) · `ZtLqbEgmNoHJ8rxgl5bcYcytnsy`

**3、进入后会让你实名认证，按照要求进行认证。然后再点击控制台，你就会看到下方这个页面。**

**4、点击右侧的：查看API key**

> [!abstract]- 🖼 图片展示的是智语AI开发者中心的控制台界面。左侧显示欢迎语及GLM - 
> 图片展示的是智语AI开发者中心的控制台界面。左侧显示欢迎语及GLM - 4和GLM - 3 - Turbo两款模型的介绍，下方有应用场景示例。右侧是用户信息区域，有查看API key按钮，费用显示为0元，还呈现了最近6个月的消费趋势图。该图片与文档中“注册Coze.cn账号”步骤相关，是进入网站主页后看到的界面，用于辅助用户了解网站功能及模型信息。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/T0x6bMlmBoB4xhxIAbwcJrncnCd) · `T0x6bMlmBoB4xhxIAbwcJrncnCd`

**5、点击添加新的API key，随便命名 ，点击确定，再点击复制。**

**\* 把这一串编码，暂时保存到你的微信上或别的地方，正式搭建时会用到。**

> [!abstract]- 🖼 图片展示的是
> 图片展示的是
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/EHCwb8ssMoIvZGxoEGdcpKwRnLd) · `EHCwb8ssMoIvZGxoEGdcpKwRnLd`

### 3、注册Coze.cn账号

**1、点击：www.coze.cn 进入网站主页。**

> [!abstract]- 🖼 图片展示的是Coze.cn网站主页。上方有“文档”和“开始使用”按钮，其
> 图片展示的是Coze.cn网站主页。上方有“文档”和“开始使用”按钮，其中“开始使用”按钮被红色框线突出显示。中部有“决胜绿茵之巅，欧洲杯赛程一手掌握”等宣传语及“立即聊聊”按钮，右侧是欧洲杯比赛场景的图片。下方有多个分类标签，如“推荐”“六月专题”等，以及“智能问题解决专家”“拼图游乐馆”“行业专家团”等板块内容。该图片与文档中注册Coze.cn账号的步骤相关，展示了网站主页界面。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/PcpbbY0uOomEIExLcaecO6KHnbd) · `PcpbbY0uOomEIExLcaecO6KHnbd`

**2、输入手机号、或者抖音一键登录皆可。**

> [!abstract]- 🖼 图片展示的是Coze.cn网站的登录页面。页面上方显示“欢迎使用扣子”，
> 图片展示的是Coze.cn网站的登录页面。页面上方显示“欢迎使用扣子”，中间有“抖音一键登录”按钮，下方有手机号输入框，已输入部分号码，下方还有“下一步”按钮。页面底部有勾选框，提示已阅读并同意扣子使用协议、扣子隐私政策、火山引擎服务条款和火山引擎隐私政策。该图片与文档中“注册Coze.cn账号”步骤相关，是输入手机号并点击“下一步”前的登录页面展示。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/HwkWbdFiXomfGSx0gqZcfiIWnYd) · `HwkWbdFiXomfGSx0gqZcfiIWnYd`

**3、登录后，需要设置你的用户名，这个用户名在Coze中相当于你的账号。只能输入英文字母和下划线。**
...
> [!abstract]- 🖼 图片是AI Agent共学快闪活动第三期 - 微信Bot搭建的宣传海报。
> 图片是AI Agent共学快闪活动第三期 - 微信Bot搭建的宣传海报。海报背景为浅绿色，上方有“WaytoAGI”标识及两个卡通机器人头像。中间以绿色文字呈现活动主题及时间，下方列出6月19 - 27日每天20:00的课程安排，包括搭建微信机器人、接入Coze API、插件拓展教学等，还特别提到虚拟女友“李洛云”开发者自述及本地部署教学等内容。底部有二维码，分别对应飞书群交流、视频号同步直播及说明文档及作业。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/N88RbkXvrov07Kxh1vocMVJtnab) · `N88RbkXvrov07Kxh1vocMVJtnab`
...
群里有很多机器人 ❤大家自行体验 互帮互助，欢迎把自己建好的机器人拉到群里检测
...
**分享：**活动期间根据日程安排每天或隔天都有一场大咖分享，让大家从零开始一步一步来了解微信机器人的搭建和深入学习。

**竞赛：**目的以赛带练，通过趣味性、时间性来促进大家快速学习和掌握基本的微信智能助手全方面，但是否开展比赛将基于参与者的热情和基本知识掌握情况再做计划。

**互助交流：**如果大家在活动期间有任何关于微信机器人 的问题都可以通过线上线下两种答疑方式得到解惑，具体请看答疑部分。也可以在飞书群里直接进行互相交流。
...
只要线上有分享话题， 都会安排答疑，在分享过程中也有助教解答大家在聊天区域提出的问题，但是由于参与人可能会比较多，现场没有被解答的问题可在大群提出，分享嘉宾和助教也会帮助解答。
