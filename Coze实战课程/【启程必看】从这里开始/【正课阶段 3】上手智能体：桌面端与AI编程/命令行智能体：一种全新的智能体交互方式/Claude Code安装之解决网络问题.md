...
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/UJMOwbQm5iyjwpkbQmJciFe7nWe
node_token: UJMOwbQm5iyjwpkbQmJciFe7nWe
obj_token: Id7vdXvEsoBQBYxRSfbcCZ8Hnfc
obj_type: docx
...
> [!abstract]- 🖼 图片展示了魔法工具对网络访问的覆盖范围。魔法工具天然支持在浏览器访问谷歌
> 图片展示了魔法工具对网络访问的覆盖范围。魔法工具天然支持在浏览器访问谷歌、本地APP访问（如微信、钉钉），但终端访问需配置。图中以箭头和文字说明，终端访问被红色框突出显示，强调其需配置。该图与上下文紧密相关，直观呈现了魔法工具网络工具作用范围的差异，帮助理解在安装Claude Code时终端网络不受魔法工具影响的问题。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/J2nBbizkNoMYIqxXCs8c86a1n4e) · `J2nBbizkNoMYIqxXCs8c86a1n4e`
...
> [!abstract]- 🖼 图片展示了Windows终端执行curl命令的相关内容。左侧红框内是“问
> 图片展示了Windows终端执行curl命令的相关内容。左侧红框内是“问你的豆包”字样，右侧红框内显示“curl ipinfo.io”及询问该命令在Windows终端执行时的样子。下方文字说明在Windows里直接用curl ipinfo.io会默认调用系统自带的Invoke-WebRequest，不是真正的curl，有PowerShell最通用写法（推荐）和更标准一点的写法，分别展示了对应的命令代码。该图片与上文提到的Windows电脑执行curl命令时的默认情况及两种写法相呼应。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/EJ9FbWmQ3oOzpmxcjC3cLAuhnec) · `EJ9FbWmQ3oOzpmxcjC3cLAuhnec`
...
> [!abstract]- 🖼 图片展示的是Panda的代理增强界面中设置部分。界面中有“工作方式”选项
> 图片展示的是Panda的代理增强界面中设置部分。界面中有“工作方式”选项，可选择“增强模式”或“代理模式”，当前选中“增强模式”。此外，还有“设置系统代理”选项，可选择“手动设置”或“自动设置”，当前选为“自动设置”。该图片与文档中“让你的网络工具覆盖终端（方法二）”部分内容相关，是介绍使用Panda的小伙伴代理增强界面设置时的工作方式选择界面。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/N0kVb5vWKoAZYNxKY6bcn64Bnsf) · `N0kVb5vWKoAZYNxKY6bcn64Bnsf`
