...
- [[30-资源/课程/Coze实战课程/10-课本章/AI零基础到智能体高手/小白也能听懂的AI编程基础课/08｜数据类型，一切数据的基础|08｜数据类型，一切数据的基础]]
...
这时候大家一定要先去了解下JSON的格式哦：[数据的桥梁｜理解与应用JSON](https://axsppz4oyvj.feishu.cn/wiki/Gye5w5o26iLzJWk4DAxcfDChnic)
