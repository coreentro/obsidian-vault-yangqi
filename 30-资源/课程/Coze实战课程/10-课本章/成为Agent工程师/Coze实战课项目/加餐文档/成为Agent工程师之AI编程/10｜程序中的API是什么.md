---
title: "10｜程序中的API是什么"
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/WECuwVt6NiA1nbkZS9IcbW1FnCe
node_token: WECuwVt6NiA1nbkZS9IcbW1FnCe
obj_token: KLdgdsm63omGxJx3CjJcAc6enPg
obj_type: docx
...
为了完整的讲清楚API的概念，我一共筹划了四篇文章

其中前三篇如下：

- [[30-资源/课程/Coze实战课程/10-课本章/成为Agent工程师/Coze实战课项目/加餐文档/成为Agent工程师之AI编程/06｜数据的桥梁，理解与应用JSON|06｜数据的桥梁，理解与应用JSON]]
- [[30-资源/课程/Coze实战课程/10-课本章/成为Agent工程师/Coze实战课项目/加餐文档/成为Agent工程师之AI编程/08｜数据类型，一切数据的基础|08｜数据类型，一切数据的基础]]
- [[30-资源/课程/Coze实战课程/10-课本章/成为Agent工程师/Coze实战课项目/加餐文档/成为Agent工程师之AI编程/09｜程序中的变量|09｜程序中的变量]]
...
<whiteboard token="ST3gwNhcLhvTc5bxNB0cKjmVnwb"></whiteboard>
...
> 图片展示的是一个应用程序界面中的模型设置部分。在“模型”下拉框中，选中了“豆包·Function call模型 32K”。下方有多个模型选项，其中“Moonshot（8K）”“Moonshot（32K）”“Moonshot（128K）”被红色框突出显示。这些模型选项对应不同大小的参数量，如8K、32K、128K。该图片与上下文介绍API组成的三要素相关，用生活中容易理解的场景类比，直观呈现了模型设置中的不同模型选项。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/SmwAb43RIo7QnLxkyA8cbBL2nld) · `SmwAb43RIo7QnLxkyA8cbBL2nld`
...
> [!abstract]- 🖼 图片展示了API基础信息相关内容。请求方式为POST，请求地址为http
> 图片展示了API基础信息相关内容。请求方式为POST，请求地址为https://api.coze.cn/v3/chat，权限为chat，需确保调用该接口使用的个人令牌开通了chat权限，接口说明是调用此接口发起一次对话，支持添加上下文和流式响应。该图片与文档中请求路径定义及请求方式部分内容相关，直观呈现了API基础信息中的关键参数和说明。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/JGS4bur4io1FhNxTSqEcWeThnU2) · `JGS4bur4io1FhNxTSqEcWeThnU2`

## 请求方式

> [!abstract]- 🖼 图片展示了一个API相关界面，其中“请求方式”一栏以红色框高亮显示，内容
> 图片展示了一个API相关界面，其中“请求方式”一栏以红色框高亮显示，内容为POST。此外，还显示了请求地址为https://api.coze.cn/v3/chat，权限为chat，并提示调用该接口需确保个人令牌开通chat权限。接口说明指出调用此接口可发起一次对话，支持添加上下文和流式响应。图片与上下文紧密相关，直观呈现了上下文中提到的API常见请求方式之一POST，帮助理解相关概念。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/RHSSb3TYjoUQSQxqppSct0DunLh) · `RHSSb3TYjoUQSQxqppSct0DunLh`
...
> 图片展示了API请求地址的相关信息。其中“请求地址”栏以红色框突出显示，内容为“https://api.coze.cn/v3/chat”。该图片与文档中“请求地址”部分内容对应，是对请求地址这一概念的具体示例呈现，帮助读者更直观地理解请求地址在API中的作用，即确定应用程序位置，是API请求路径定义中不可或缺的一环。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/C5rVbiuX1ooT5uxL6nKcyOIwn8b) · `C5rVbiuX1ooT5uxL6nKcyOIwn8b`
...
> [!abstract]- 🖼 图片展示的是一个查询IP地址的网站界面。上方显示“我的IP地址是：124
> 图片展示的是一个查询IP地址的网站界面。上方显示“我的IP地址是：124.160.201.181”，并有“其他IP查询”和“此处广告位招租”两个蓝色文字选项。下方表格中，左侧“IP”栏显示124.160.201.181，“IPv6”栏显示::7ca0:c9b5。右上角有“查看自己的IP地址”蓝色文字。该图片与文档中介绍IP地址的内容相关，用于直观呈现查询IP地址的结果，帮助理解互联网中服务器通过IP地址定位的原理。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/KW27bhcyno8AuPxKGApc7BNznv8) · `KW27bhcyno8AuPxKGApc7BNznv8`
...
> 图片展示了Coze API接口的相关信息。其中，“权限”部分以红色框突出显示，明确指出调用该接口需确保使用的个人令牌开通了“chat”权限，详情可参考“鉴权”。该图片与文档中“权限”部分内容对应，直观呈现了使用Coze API接口时对权限的具体要求，帮助开发者明确权限开通条件，确保接口调用的顺利进行。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/JSZdbdIWsoZ8g7xfzNocLBdAnsh) · `JSZdbdIWsoZ8g7xfzNocLBdAnsh`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/W2uFbY5p8oaMGPx9UTacPqpqn2g) · `W2uFbY5p8oaMGPx9UTacPqpqn2g`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Lq7Db6oH7opLLkxZF2wcBCLdnnf) · `Lq7Db6oH7opLLkxZF2wcBCLdnnf`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/TxaNbg8XAoWc9Fxdvlyc3DomnTe) · `TxaNbg8XAoWc9Fxdvlyc3DomnTe`
...
> [!abstract]- 🖼 图片展示了API接口的详细信息。请求方式为GET，请求地址是https:
> 图片展示了API接口的详细信息。请求方式为GET，请求地址是https://api.coze.cn/v1/space/published_bots_list，权限为getPublishedBot，接口说明是调用接口查看指定空间发布到Bot as API渠道的Bot列表。其中，请求方式和请求地址被红色框线突出显示，与上下文提到的GET请求及Query形式的参数例子相呼应，直观呈现了典型GET请求&Query参数的接口配置情况。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/MFd1bcyFrocw81xImLzcFBeunNP) · `MFd1bcyFrocw81xImLzcFBeunNP`

> [!abstract]- 🖼 图片展示了GET请求中Query形式的参数示例。表格中包含参数、类型、是
> 图片展示了GET请求中Query形式的参数示例。表格中包含参数、类型、是否必选及说明四列。参数有space_id、page_size、page_index，类型均为String或Integer，其中space_id为必选，page_size和page_index为可选。space_id说明为Bot所在空间的唯一标识，page_size说明默认为20，page_index说明默认为1。该图片与文档中介绍GET请求及Query形式参数的内容相关，直观呈现了相关参数信息。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/BvvGbieSuoTiUoxP3Ahcunzunfe) · `BvvGbieSuoTiUoxP3Ahcunzunfe`
...
> 图片展示了API的请求方式、请求地址、权限及接口说明等信息。其中，请求方式为POST，请求地址是https://api.coze.cn/v3/chat，权限为chat，需确保调用该接口使用的个人令牌开通了chat权限，接口说明为调用此接口发起一次对话，支持添加上下文和流式响应。该图片与上文介绍API入参的内容相关，直观呈现了API请求的基本配置信息。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/PI8Bb1ecEoG0oSxuoZZci9kznAg) · `PI8Bb1ecEoG0oSxuoZZci9kznAg`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/R5xwbcO96oNg9zxHafPcz9kDnBe) · `R5xwbcO96oNg9zxHafPcz9kDnBe`

> [!abstract]- 🖼 图片展示了一个API的输入参数“Query”相关内容。左侧表格中列出了参
> 图片展示了一个API的输入参数“Query”相关内容。左侧表格中列出了参数“conversation_id”，其类型为String，是否必选为可选，说明是标识对话发生在哪一次会话中，并对会话的概念、使用已创建会话的方式以及可不传该参数的场景等进行了详细说明，还给出了调用报错情况。右侧基础信息区域也突出显示了“Query”。此图片与上下文关于API入参的讨论相关，直观呈现了“Query”部分的参数细节。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/PByZbgD3IoNUMmxm06PcNRCanng) · `PByZbgD3IoNUMmxm06PcNRCanng`

PS：**如果文档中标注的是Body参数，代表这些参数是通过JSON的方式输入的**

这时候大家一定要先去了解下JSON的格式哦：[[30-资源/课程/Coze实战课程/10-课本章/成为Agent工程师/Coze实战课项目/加餐文档/成为Agent工程师之AI编程/06｜数据的桥梁，理解与应用JSON|06｜数据的桥梁，理解与应用JSON]]
...
> 图片展示的是Coze平台发布Bot的界面。在“选择发布平台”部分，有多个平台选项，如抖音、飞书等，其中“Bot as API”选项被红色框线突出显示，其状态为“已提交”。右上角有“发布”按钮。该图片与文档中“在个人空间创建一个Bot，发布的时候勾选Bot API”的内容相关，直观呈现了发布Bot时选择Bot as API的操作界面，帮助用户明确操作位置。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/S15BblktBoVk9bxPsWbcUaG0nFh) · `S15BblktBoVk9bxPsWbcUaG0nFh`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/BGjcb7jcmoyKI7xxfWecMDGMnoh) · `BGjcb7jcmoyKI7xxfWecMDGMnoh`

> [!abstract]- 🖼 图片展示了在浏览器中打开Coze Bot的页面，地址栏内容为“https
> 图片展示了在浏览器中打开Coze Bot的页面，地址栏内容为“https://www.coze.cn/space/7331741379686826035/bot/7393008672953679913”。画面中有一个红色框突出显示地址栏内容，并有红色箭头指向，旁边文字提示“复制地址栏内容”。这与文档中“在个人空间，点击刚刚发布的Bot，一定要在个人空间哦”及“提取最后面那串数字：7393008672953679913”的内容相关，用于指导用户获取Bot的地址栏内容。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/SFMNbmtX8oEycwxCHD1cRvoanLf) · `SFMNbmtX8oEycwxCHD1cRvoanLf`
...
> 图片展示的是Coze平台中个人访问令牌管理界面。界面上方有“个人访问令牌”“OAuth应用”“已授权应用”三个选项卡，当前选中“个人访问令牌”。下方列表显示了两个令牌信息，包括名称、创建时间、最近使用时间、过期时间、状态及操作栏。右上角有“添加新令牌”蓝色按钮，下方有红色箭头指向该按钮，提示点击添加新令牌。该图片与文档中申请Coze Token部分内容相关，用于说明申请Token的操作位置。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/LyFMbFsxgoCzYtxbocBcTNHbn0A) · `LyFMbFsxgoCzYtxbocBcTNHbn0A`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/AEXdb73CUoPlvrx4kztcv6Qsndf) · `AEXdb73CUoPlvrx4kztcv6Qsndf`

> [!abstract]- 🖼 图片展示了Coze平台申请个人访问令牌的界面。界面中强调令牌仅显示一次，
> 图片展示了Coze平台申请个人访问令牌的界面。界面中强调令牌仅显示一次，需保存在安全且可获取的地方，不可与他人共享，也不要在浏览器或其他客户端代码中暴露。下方有“名称”“过期时间”“令牌”等信息栏，其中“令牌”处显示了令牌内容。图片右下角有一个文件夹图标。该图片与文档中“申请自己的Coze Token”部分内容相关，是申请令牌成功后的展示界面，用于说明令牌获取后的保存注意事项。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/JeczbJliLoSojixvsMRcy9WWnpc) · `JeczbJliLoSojixvsMRcy9WWnpc`
...
> 图片展示了在ChinaZ在线调试工具中测试Coze API的界面。关键信息有：请求地址为https://api.coze.cn/v3/chat，需注意HTTPS；请求方式为POST；Header设置有Content-Type和Authorization；入参为JSON字符串设置；返回值位于下方区域。该图与文档中介绍如何测试Coze API的内容相关，直观呈现了测试时在工具中设置请求地址、方式、Header、入参等操作及返回结果的界面。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/U8FiblbsooHRvSxyrZgcgmN4nrb) · `U8FiblbsooHRvSxyrZgcgmN4nrb`
...
> 图片展示了HTTPie测试工具界面中调用https://api.coze.cn/v3/chat/message/list接口的设置情况。关键信息有：请求地址为HTTPS链接；请求方式为GET；Header设置有Content-Type和Authorization；参数设置为Query形式，包含conversation_id和chat_id；返回值为JSON格式，显示了对话内容等信息。该图与上文介绍的调用查看消息API的步骤相关，直观呈现了API调用时的参数设置及返回结果。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/BdCXbHNgFoYHplx5qSacNgf0nXg) · `BdCXbHNgFoYHplx5qSacNgf0nXg`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/P5GCbBzS0oyKa3xF87acOkGBnPh) · `P5GCbBzS0oyKa3xF87acOkGBnPh`
