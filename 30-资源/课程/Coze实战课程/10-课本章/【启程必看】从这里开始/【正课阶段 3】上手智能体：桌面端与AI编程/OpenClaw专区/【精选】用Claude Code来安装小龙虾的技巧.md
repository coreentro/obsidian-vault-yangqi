---
title: "【精选】用Claude Code来安装小龙虾的技巧"
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/P8pTwh6KCi1v6skXAKHcbVJyn9c
node_token: P8pTwh6KCi1v6skXAKHcbVJyn9c
obj_token: BdSsdXbecoCB5PxsmpxcTEl9nOd
obj_type: docx
...
> [!abstract]- 🖼 图片展示了腾讯云轻量应用服务器的多种配置及价格信息。其中，4核8G30M
> 图片展示了腾讯云轻量应用服务器的多种配置及价格信息。其中，4核8G30M配置的轻量应用服务器，地域为新加坡，时长1月，日均价8.85元/月，活动价88元，每日优惠210元，可立即购买。此外，还有2核4G30M、2核2G20M等不同配置的轻量应用服务器，各具价格优势，如2核4G30M配置的日均价为6.85元/月，活动价99元。该图片与文档中使用腾讯云部署小龙虾的内容相关，为部署提供服务器配置参考。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/N1pxbJ5PqoXjq4x1aadc54aQnde) · `N1pxbJ5PqoXjq4x1aadc54aQnde`

> [!abstract]- 🖼 图片展示了OpenClaudeChataibot - v1.50的界面。
> 图片展示了OpenClaudeChataibot - v1.50的界面。左侧为文件管理器，显示显示“root”目录下的“openclaw”文件夹。右侧是Claude Code v2.1.50界面，欢迎语为“Welcome back!”，并提示使用“/init”创建CLAUE.md文件以指导Claude。下方显示Opus 4.6版本信息，API使用计费为Opus 4.6，当前活动无记录。该图片与文档中介绍使用Claude Code安装小龙虾的教程上下文相关，展示了安装后Claude Code的初始界面情况。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Udwob23MTo9X9fxGCFYcmub2nhe) · `Udwob23MTo9X9fxGCFYcmub2nhe`
...
> 图片展示了一可以更好
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/CD88bGWKPohxusxZ2NFchsSlnhg) · `CD88bGWKPohxusxZ2NFchsSlnhg`
...
> 图片展示了OpenClaw专区的相关内容。专区下有五个帖子标题，分别是“OpenClaw这么火，到底该怎么学？我的答案可能和你...”“开启龙虾学习前，我想对你说的话”“OpenClaw安装与部署的3种方式”“小白一键部署的几种方案”“为你的龙虾安装大脑”。这些帖子标题与文档中作者在学习和使用OpenClaw、思考小白学习路径及分享养虾感悟的内容相呼应，体现了作者在OpenClaw学习与应用方面的思考与实践。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/CQrkbUka4ocXuhxpo4DcqNdsnZb) · `CQrkbUka4ocXuhxpo4DcqNdsnZb`
...
> [!abstract]- 🖼 图片展示了养 addCriterion图片展示了养虾日常中遇到的Bug情
> 图片展示了养 addCriterion图片展示了养虾日常中遇到的Bug情况，分为突然不回复、版本更新、装插件死机三种场景。突然不回复时系统静默无响应，版本更新时飞书通道突然失效，装插件死机时整个系统崩溃。这些场景都是作者在养虾过程中真实遇到的，且全部靠Claude Code解决，哪怕资深程序员也未必能自己搞定。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/NuicbP5DVoxlzmxNrRtcORVxn3d) · `NuicbP5DVoxlzmxNrRtcORVxn3d`
...
> [!abstract]- 🖼 图片展示了Claude Code Code v2.1.71的界面，突出显
> 图片展示了Claude Code Code v2.1.71的界面，突出显示了OpenClaw助手的主要内容 自动生成的职责，包括学习引导、配置管理、故障排查、知识沉淀等，强调其理念是费量学习法，可直接对话学会OpenClaw。该图片与文档中作者养虾过程中遇到问题需Claude Code解决的内容相关，体现了作者对Cla的依赖及对社群伙伴提供真正学会AI教程的思考。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/ThdLbrUppoyOhYxKUpZcLY3In3c) · `ThdLbrUppoyOhYxKUpZcLY3In3c`
...
> 图片展示了“AI编程必知必会的基础知识”板块内容，包含“服务器与操作系统”和“程序中的API是什么”两个子项。该图片位于介绍用Claude addCriterion addCriterion
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/AXKpbg2bDoIqVKxsGyZcoex6nfb) · `AXKpbg2bDoIqVKxsGyZcoex6nfb`

所以有了今天的分享。我想把我这几天是怎么学习OpenClaw，以及我总结出来的使用Claude Code学习任何新知识的方法论分享给大家

# 三、我是如何用Claude Code学习小龙虾的

> [!abstract]- 🖼 图片展示了作者学习OpenClaw的工具及步骤流程。从一个简笔小人开始，
> 图片展示了作者学习OpenClaw的工具及步骤流程。从一个简笔小人开始，箭头依次指向“买一台服务器”“装Claude Code”，再分别指向“建立一个文件夹《OpenClaw管理助手》”和“装龙虾、学习龙虾、修复龙虾bug”。底部有两个亮色突出部分，分别是“Cherry Studio”和“谷歌浏览器”。图片与上下文关系紧密，上下文提到图片是学习OpenClaw的所有工具，接下来会剖析各工具作用，图片直观呈现了学习流程及相关工具。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Qgt7bdkWEoN8e5xSNMfcbz5Fnue) · `Qgt7bdkWEoN8e5xSNMfcbz5Fnue`
...
> 图片展示的是一个学习交流群的聊天记录。群内成员就安装Claude Code及使用体验展开讨论。孔繁伟提到安装过程不仅教会了如何安装，还让他掌握了有问题自己和AI一起解决的思路。周凯、王小云等成员也分享了安装成功或遇到问题的经历。陆爱萍按步骤操作后，虽遇到问题但最终解决，还表达了对AI辅助解答的认可。该图片与文档中介绍学习OpenClaw工具时提到的Claude Code安装相关，展示了学习过程中的交流情况。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Ovnnblrqtot4p5x9AfRcnqHInff) · `Ovnnblrqtot4p5x9AfRcnqHInff`
...
> 图片展示的是ZCF - Zero-Config Code Flow的页面。页面上方有多个标签，如“downloads”“License”“Claude Code”等。页面中间有“ZCF addCriterion图片
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/W3aZbsBYXog2oUx22rkcakGenme) · `W3aZbsBYXog2oUx22rkcakGenme`
...
> [!abstract]- 🖼 图片展示了在Finder中打开的“projects”文件夹内容。其中，“
> 图片展示了在Finder中打开的“projects”文件夹内容。其中，“openclaw”文件夹被红色框突出显示，创建于2026年3月15日1:45 AM，其下有“CLAUDE.md”文档和“refs”文件夹。该图片与上文提到的建立文件夹学习小龙虾的内容相关，直观呈现了作者在“projects”文件夹下建立的“openclaw”文件夹，该文件夹是后续用Claude Code学习小龙虾项目的基础。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/KXjvbUR71oDn3QxkqtBcadWtncn) · `KXjvbUR71oDn3QxkqtBcadWtncn`

> [!abstract]- 🖼 图片展示了名为OpenClaw的文件夹目录。文件夹内有一个名为CLAUD
> 图片展示了名为OpenClaw的文件夹目录。文件夹内有一个名为CLAUDE.md的文档，文件大小为2.59 kB，修改日期为2026年3月7日1:04 AM。还有一个名为refs的子文件夹，修改日期为2026年3月15日1:45 AM 。该图片与上文提到的“建立一个文件夹，展示建立的文件夹目录”相呼应，直观呈现了OpenClaw文件夹中的核心文档CLAUDE.md及refs子文件夹等内容。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/LwKYbtTXKodt39x79JXcP9Wvnwd) · `LwKYbtTXKodt39x79JXcP9Wvnwd`
...
> [!abstract]- 🖼 图片展示了用Claude Code学习小龙虾的流程。从买一台服务器开始，
> 图片展示了用Claude Code学习小龙虾的流程。从买一台服务器开始，接着装Claude Code，再建立《OpenClaw管理助手》文件夹，同时装龙虾学习小龙虾并修复bug。图片下方有Cherry Studio和谷歌浏览器两个橙色框，分别对应文档中提到的查数据和解释概念的工具，与上下文对这两个工具的介绍相呼应。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/FrKEbSgCMoqocvx5mOocalR2nzc) · `FrKEbSgCMoqocvx5mOocalR2nzc`
...
> 图片展示了 addCriterion
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/XG5WbPaSNoOJkFxeTYjctx3OnTh) · `XG5WbPaSNoOJkFxeTYjctx3OnTh`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/B00NbIYdQoTLvTxePsecaFMWnOc) · `B00NbIYdQoTLvTxePsecaFMWnOc`
...
> [!abstract]- 🖼 图片展示了Claude Code相关教程目录，其中“让它记住你的规矩：C
> 图片展示了Claude Code相关教程目录，其中“让它记住你的规矩：CLAUDE.md 配置指南”“让重复的事情自动化：Commands、Hooks、Skills 的...”“Commands实战：把常用指令存成快捷方式”“Hooks实战：让规矩自动执行，不靠AI记忆”“给Claude装上外部能力：MCP配置指南”等内容被红色框突出显示。这些内容与文档中介绍的Claude Code相关教程相呼应，是学习Claude Code时可参考的实践操作指南。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/E3AcbnVUgott5wxXlXGcfpRznjf) · `E3AcbnVUgott5wxXlXGcfpRznjf`
...
> [!abstract]- 🖼 图片图片中，左侧是一个手持话筒的简笔人物形象，其上方有“口喷观点”的文字
> 图片图片中，左侧是一个手持话筒的简笔人物形象，其上方有“口喷观点”的文字。右侧依次展示了“朋友圈写作”“转换小绿书”“发布草稿箱”三个流程框，分别对应“wechat-pyq-writer”“wechat-newspic-writer”
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Aoewbb1pdotgPHxIXvwc5jKInbf) · `Aoewbb1pdotgPHxIXvwc5jKInbf`
...
> 图片展示了人和AI的正向飞轮关系。左侧“我越强”代表综合能力+领域知识，右侧“AI越强”代表更精准的上下文+执行，两者通过“提供更好的上下文”和“产出更好的结果，反哺学习”相互促进。下方有两组对比，左侧“只想让AI强”焦虑，永远追不上变化；右侧“每件事都让自己变强”正向飞轮，立于不败之地。核心观点是：不是AI技能不够，是综合能力的问题。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Hds9bpCvYoe89GxM6OycZw7KnDd) · `Hds9bpCvYoe89GxM6OycZw7KnDd`
