---
title: "2026-03-16 分享 - 聊聊Claude Code的使用技巧"
feishu_url: https://axsppz4oyvj.feishu.cn/wiki/A1r3wzs6xiWqc7k38BSccLwsnu7
node_token: A1r3wzs6xiWqc7k38BSccLwsnu7
obj_token: C3bjdyD7xoFiRZxKttHc9tVsnR5
obj_type: docx
...
breadcrumb:
  - "【启程必看】从这里开始"
  - "【加餐 3】有价值的直播和资料"
  - "2026-03-16 分享 - 聊聊Claude Code的使用技巧"
obj_create_time: 
obj_edit_time: 
creator: 
owner: 
...
<callout emoji="✨">
这节课是一场视频号的公开直播。下面是文字版，但如果有时间的话，我强烈建议你听一下视频版，里面有我的情绪，有我对这件事情的理解
这场分享质量非常高，我把我对 Claude Code 的理解，以及如何用 Claude Code 去学习任何知识，全部分享在了里面
</callout>
...
> 图片展示了一台MacBook Air笔记本电脑，放置在木质桌面上。电脑屏幕上显示着代码界面，其中突出显示了“CLAUDE CODE”字样，下方有代码内容。屏幕右上角有飞书聊天窗口。电脑左侧有充电线和数据线，右侧有鼠标。背景中可见沙发、枕头等家居物品。此图与文档中介绍部署方式的内容相关，展示了使用MacBook Air部署项目时的场景。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/GOYIbPWfXoYRdWxzE4XcLwt8n2d) · `GOYIbPWfXoYRdWxzE4XcLwt8n2d`
...
> 图片展示了OpenClaw专区的相关内容。专区下有五个帖子标题，分别是“OpenClaw这么火，到底该怎么学？我的答案可能和你...”“开启龙虾学习前，我想对你说的话”“OpenClaw安装与部署的3种方式”“小白一键部署的几种方案”“为你的龙虾安装大脑”。这些帖子标题与文档中作者在学习和使用OpenClaw时思考的小白学习路径及分享养虾感悟的内容相呼应，体现了作者在OpenClaw学习与使用方面的思考与分享。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/BcuZbR9GxoPeV7xPn0echnWKnlf) · `BcuZbR9GxoPeV7xPn0echnWKnlf`
...
> 图片展示了养虾日常中遇到的Bug情况。上方标题为“养虾日常 Bug满天飞的真实现场”，下方有三个分支，分别是“突然不回复 系统静默无响应”“版本更新 飞书通道突然失效”“装插件死机 整个系统崩溃”。最下方总结“全部靠Claude Code解决 哪怕资深程序员也未必能自己搞定”。该图与上下文紧密相关，直观呈现了作者在养虾过程中遇到的系统问题，为后续介绍使用Claude Code解决这些问题做铺垫。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/UwDbb4vHBoHwp1xMjA0cMcuanif) · `UwDbb4vHBoHwp1xMjA0cMcuanif`
...
> [!abstract]- 🖼 图片展示了Claude Code2.1.71版本的界面，突出显示了Ope
> 图片展示了Claude Code2.1.71版本的界面，突出显示了OpenClaw助手的主要职责，包括学习引导、配置管理、故障排查和知识沉淀。其知识来源优先级为先查本地refs/文档，再查官网，查完后把有价值的内容沉淀到本地>
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/SN0xbmSd8of2vexL7idcO4UynRR) · `SN0xbmSd8of2vexL7idcO4UynRR`
...
> 图片展示了“AI编程必知必会的基础知识”板块内容，包含“服务器与操作系统”和“程序中的API是什么”两个子项。该图片位于介绍Claude Code使用技巧的文档中，与上下文紧密相关，上下文提到作者在写教程时遇到问题需Claude Code解决，意识到纯教程内容已不太适用，社群伙伴更需思维方法类内容，此图片可能是在展示作者在AI编程方面需掌握的基础知识，为后续分享提供背景信息。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/HPOzbAxZ0oaRl6xYizPcWGCxnsb) · `HPOzbAxZ0oaRl6xYizPcWGCxnsb`

所以有了今天的分享。我想把我这几天是怎么学习OpenClaw，以及我总结出来的使用Claude Code学习任何新知识的方法论分享给大家

# 三、我是如何用Claude Code学习小龙虾的

> [!abstract]- 🖼 图片展示了学习 addCriterion addCriterion
> 图片展示了学习 addCriterion addCriterion
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/WDNTbKf5loEbfoxvuAxcvfO9nSe) · `WDNTbKf5loEbfoxvuAxcvfO9nSe`
...
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/HtTbbeENNojehWxkQNycQoEznaf) · `HtTbbeENNojehWxkQNycQoEznaf`
...
> （无描述）
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/XfymbcUFroTzJkxm3C6c9vrmnyz) · `XfymbcUFroTzJkxm3C6c9vrmnyz`
...
> [!abstract]- 🖼 图片展示了在Finder中打开的 Users > bonnie > pr
> 图片展示了在Finder中打开的 Users > bonnie > projects文件夹后的界面。其中，名为“openclaw”的文件夹以
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/J3F5bIRJZoDP9xxQ6rmcgBkLnqd) · `J3F5bIRJZoDP9xxQ6rmcgBkLnqd`

> [!abstract]- 🖼 配图
> （无描述）
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/LhgYbqiMloK0pIxRjiccTYF7nBf) · `LhgYbqiMloK0pIxRjiccTYF7nBf`
...
> 图片展示了
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/Acq2bymBioEMXFxRqkgc2bqAn4b) · `Acq2bymBioEMXFxRqkgc2bqAn4b`
...
> [!abstract]- 🖼 图片展示了AI时代学习任何知识的工具链。官方文档作为初始上下文、互联网搜
> 图片展示了AI时代学习任何知识的工具链。官方文档作为初始上下文、互联网搜索提供额外上下文、第三方教程插件/指南由人负责查找，这三者均指向CLAUDE.md（项目说明书+知识来源）。CLAUDE.md再与Claude Code相连，Claude Code是通用智能体，可思考、执行与沉淀，下方还列出其具体任务为安装配置、排查故障和沉淀知识。此图与上文用Claude Code学习小龙虾的内容相关，总结了使用Claude Code学习时的工具链条和流程。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/HZHzbzbtYotFeUxUB39cSV9nnRo) · `HZHzbzbtYotFeUxUB39cSV9nnRo`
...
> 图片展示的是Cherry Studio的界面。左侧为导航栏，有“新线程”“自动化”“技能”“线程”“Playground”等选项，当前选中“新线程”。右侧是新线程界面，上方有“新线程”标题，下方有“开始构建Playground”提示，下方输入框提示“向 Codex 任意提问，@ 添加文件，/ 调出命令”，下方还有GPT - 5.4、中等大小等选项。该图片与上下文介绍的Cherry Studio是一个对话软件，其优势在于token消耗少，当有概念不了解时可与之聊天学习相呼应。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/CeP6bUoVKo05jnxGyFBcShm2nVc) · `CeP6bUoVKo05jnxGyFBcShm2nVc`
...
> [!abstract]- 🖼 图片展示了Cla addCriterion addCriterionCl
> 图片展示了Cla addCriterion addCriterionClaude Code相关教程目录。其中，红色框内列出了多个 addCriterionClaude Code相关教程目录。其中，红色框内列出了“让它记住你的规矩：CLAUDE.md 配置指南”“让重复的事情自动化：Commands、Hooks、Skills 的...”“Commands 实战：把常用指令存成快捷方式”“Hooks 实战：让规矩自动执行，不靠 AI 记忆”“给Claude装上外部能力：MCP 配置指南”等教程，属于
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/RdMnbk0stoK6CrxDP54ci9xEnjb) · `RdMnbk0stoK6CrxDP54ci9xEnjb`
...
> [!abstract]- 🖼 图片展示了微信朋友圈写作、转换小绿书及发布草稿箱的业务工作流。左侧“口喷
> 图片展示了微信朋友圈写作、转换小绿书及发布草稿箱的业务工作流。左侧“口喷观点”的人指向“朋友圈写作”；“朋友圈写作”指向“转换小绿书”；“转换小绿书”指向“发布草稿箱”。下方有三个文件夹图标，分别对应“wechat-pyq-writer”“wechat-newspic-writer”“wechat-newspic-publisher”，与上文提到的技能相关，体现了技能在业务工作流中的应用。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/N4xmb8RKHoGATXxa8s7cY676npb) · `N4xmb8RKHoGATXxa8s7cY676npb`
...
> [!abstract]- 🖼 图片展示了人和AI的正向飞轮关系。左侧紫色框内“我越强”代表综合能力+领
> 图片展示了人和AI的正向飞轮关系。左侧紫色框内“我越强”代表综合能力+领域知识，右侧绿色框内“AI越强”代表更精准的上下文+执行，两者通过“提供更好的上下文”和“产出更好的结果，反哺学习”双向箭头连接。下方有两组对比，左侧红色框“只想让AI强”对应焦虑→永远追不上变化，右侧绿色框“每件事都让自己变强”对应正向飞轮→立于不败之地。底部核心观点为“不是AI技能不够，是综合能力的问题”。
> 
> 原图未迁移 · [飞书原图](https://feishu.cn/file/JyqxbTyh0oxrOHxDbvFcO8WsnjV) · `JyqxbTyh0oxrOHxDbvFcO8WsnjV`
