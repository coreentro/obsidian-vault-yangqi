...
如果想要详细的了解 RAG，请移步阅读：[[Coze知识库：AIGC时代的知识库原理]]

如果需要详细的了解上下文，请移步阅读：[[【必看】讲透提示词与上下文，我压箱底的 AI 沟通心法]]

如果需要了解 JOSN这种结构，请移步阅读：[[Coze中的复杂数据类型（Object与Array）]]
